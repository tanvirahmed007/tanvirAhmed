...
export const EXPERIENCES = [
  {
    year: "2022 - Present",
    role: "Jr. Programmer",
    company: "Flora Systems",
    description: `Led a team in developing and maintaining web applications using JavaScript, React.js, and Node.js. Implemented RESTful APIs and integrated with MongoDB databases. Collaborated with stakeholders to define project requirements and timelines.`,
    technologies: ["ASP.NET Core","C#","Javascript","Angular.Js", "TypeScript", "SQL Server"],
  },
...
export const PROJECTS = [
  {
    title: "Flora Bank: NCC Bank",
    image: project1,
    description:
      "A fully banking business software. Contributed on Loan,Card,Vault,Parameter module, and user authentication.",
    technologies: ["ASP.NET Core", "C#", "SQL Server", "Oracle","HTML", "CSS"],
  },
  {
    title: "Flora Bank: Trust Bank",
    image: project1,
    description:
      "A fully banking business software. Contributed on Loan,Card,Vault,Parameter module, and user authentication.",
    technologies: ["ASP.NET Core", "C#", "SQL Server", "Oracle","HTML", "CSS"],
...
export const CONTACT = {
  address: "Tolarbagh, Mirpur-1, Dhaka, Bangladesh",
  phoneNo: "01643257542",
  email: "thisistanvirmail@gmail.com",
};
